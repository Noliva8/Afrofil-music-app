...
export const songRowCodes = [
  { codeId: "newUpload", label: "New Upload" },
  { codeId: "trending", label: "Trending" },
  { codeId: "suggestedSongs", label: "Suggested Songs" },
  { codeId: "recentlyPlayed", label: "Recently Played" },
];
...
// 2) Grid-only (show all) — render only, NO query
...
// ✅ SongRowContainer (final fixed flow)
// - receives base 10 songs from parent (already presigned)
// - ONLY when showAll=true: query 20, remove base 10, presign extras, merge to 20

export function SongRowContainer({
  header = "",
  subHeader = "",
  songsWithArtwork = [], 
  onCardClick,
