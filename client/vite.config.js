...
//   server: {
//     host: "127.0.0.1",          // ✅ force IPv4 (avoid ::1 / localhost weirdness)
//     port: 3000,
//     strictPort: true,

//     hmr: {                      // ✅ pin HMR websocket target
//       protocol: "ws",
//       host: "127.0.0.1",
//       clientPort: 3000,
//     },

//     // open: true,   // optional: if this opens localhost, it can reintroduce the issue
...
//       output: {
//         manualChunks(id) {
//           if (id.includes("components/MusicPlayer/ModernMusicPlayer")) return "media-player-compact";
//           if (id.includes("components/MusicPlayer/FullScreenMediaPlayer")) return "media-player-fullscreen";
//           if (id.includes("components/MusicPlayer/ModernAdPlayer")) return "media-player-ad";
//           if (id.includes("components/MusicPlayer/MediaSessionManager")) return "media-session-manager";
//           if (id.includes("utils/Contexts/adapters/adPlayerAdapter")) return "player-adapters-ad";
//           if (id.includes("utils/Contexts/adapters/musicAdapter")) return "player-adapters-music";
//           if (id.includes("utils/Contexts/adapters/eventBus")) return "player-adapters-eventbus";
//           if (id.includes("utils/Contexts/playerAdapters.js")) return "player-adapters-utils";
//           if (id.includes("utils/Contexts/AudioPlayerContext.jsx")) return "audio-player-context";
//           if (id.includes("utils/Contexts/useNowPlayingArtwork")) return "now-playing-artwork";
//           if (id.includes("utils/Contexts/followers/useArtistFollowers")) return "artist-followers";
//           if (id.includes("@mui/x-date-pickers")) return "mui-date-pickers";
//           if (id.includes("DashbordComponents/Charts")) return "charts";
//           if (id.includes("components/ArtistMessagingPanel")) return "artist-messaging";
//           if (id.includes("components/Stripe") || id.includes("stripe")) return "stripe";
